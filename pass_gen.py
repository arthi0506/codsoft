...
Title = Label(root, text="Password Generator", bg="pale turquoise", fg="black", font=("Arial", 15, "bold"))
Title.pack(anchor="center", pady="20px")

length = Label(root, text="Select the Length of Your Password", fg="darkgreen", bg="pale turquoise", font=("Arial", 12))
length.place(x="20px", y="70px")

def on_enter(e):
    generate_btn['bg'] = "dark sea green"
    generate_btn['fg'] = "white"

def on_leave(e):
    generate_btn['bg'] = "pale green"
...
generate_btn = Button(root, text="Generate Password", bg="pale green", fg="black", font=("Arial", 15), cursor="hand2", command=password_generate)
generate_btn.bind("<Enter>", on_enter)
generate_btn.bind("<Leave>", on_leave)
generate_btn.pack(anchor="center", pady="50px")

result_lable = Label(root, text="Generated Password ", bg="pale turquoise", fg="darkgreen", font=("Arial", 12))
